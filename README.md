...
- 모델 측면에서는 SegFormer와 Attention U-Net 계열 모델의 성능 개선을 담당했습니다. 특히 Attention U-Net에 MobileNetV3 Encoder를 적용해 모델을 경량화하고, Hybrid Loss, Focal Tversky Loss, Deep Supervision 등의 방법을 실험하며 결함 영역에 대한 탐지 성능을 높이는 방향으로 고도화를 진행했습니다. 이를 통해 제조 현장에서 요구되는 정밀도와 실시간 적용 가능성 사이의 균형을 고민해볼 수 있었습니다.
